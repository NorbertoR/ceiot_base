...
#include "lwip/dns.h"
#include <bmp280.h>
#include "/home/norberto/esp/ceiot_base/config/config.h"   // esto es mejorable...
...
static char *REQUEST_POST = "POST " WEB_PATH " HTTP/1.0\r\n"
    ...
    //este funciona"id=" DEVICE_ID "&key=" DEVICE_KEY "&t=%0.2f&h=%0.2f";
    "device={\"device_id\":" DEVICE_ID ",\"device_key\":" DEVICE_KEY ",\"temperatura\":%0.2f,\"humedad:\":%0.2f}";
...
//            if (bme280p) {
                ...
                //sprintf(send_buf, REQUEST_POST, temperature , humidity, temperature);
